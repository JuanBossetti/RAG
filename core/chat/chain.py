...
from retriever import PostgresChatMessageHistoryManager
...
class Chain:
    ...
    def __init__(self, llm, retriever):
        ...
        self.sync_connection = PostgresChatMessageHistoryManager().get_connection_for_chat_history()
        PostgresChatMessageHistory.create_tables(self.sync_connection, table_name)
        
        ### Contextualize question ###  
        contextualize_q_prompt = PromptProvider.get_contextualize_prompt()              
    ...
    def get_answer(self, question, chain_uuid):
        ans = self.conversational_rag_chain.invoke(
                {"input": question},
